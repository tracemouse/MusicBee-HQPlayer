...
Partial Public Class Plugin
    ...
    Public Const MinInterfaceVersion As Short = 32
    Public Const MinApiRevision As Short = 44
    ...
    Public Delegate Function MB_AddTreeNodeDelegate(treePath As String, name As String, icon As Drawing.Bitmap, handler As EventHandler) As Boolean
